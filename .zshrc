...
# Aliases
alias c='f() { if [[ -z "$1" ]]; then cursor .; else cursor "$@"; fi };f'
alias cl='clear'
alias run='npm run'
...
alias rts='npm run test:watch -w @vasion/storage'
alias rtsu='npm run test:watch -w @vac/storage'
alias prt='f() { pnpm -F $1 test:watch };f'
alias prts='pnpm -F @vasion/storage test:watch'
alias prtsu='pnpm -F @vac/storage test:watch'
